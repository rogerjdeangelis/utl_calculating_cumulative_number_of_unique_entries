...
Cumulative count distinct by sequential groups problem
    StackOverflow R: Cumulative count distinct by sequential groups problem.

    github
    https://goo.gl/9738ZP
    https://github.com/rogerjdeangelis/utl_calculating_cumulative_number_of_unique_entries
